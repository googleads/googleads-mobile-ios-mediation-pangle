...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "PangleAdapter",
      url:
        "https://dl.google.com/googleadmobadssdk/mediation/ios/pangle/PangleAdapter-8.2.1.0.0.zip",
      checksum: "ff3b667352104d0b128bc65fe6f1f088204cdf3afc3b19d98b308c73e3f568d1"
    ),
  ]
)
